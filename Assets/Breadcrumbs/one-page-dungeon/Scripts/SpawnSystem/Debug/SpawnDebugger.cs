...
namespace Breadcrumbs.SpawnSystem.Debugger
{
    ...
    public class SpawnDebugger : MonoBehaviour
    {
        ...
        [SerializeField] private Color spawnEventColor = Color.green;
        [SerializeField] private Color despawnEventColor = Color.red;
        [SerializeField] private float eventMarkerDuration = 3f;
        [SerializeField] private int maxTrackedEvents = 100;

        [Header("Performance Monitoring")]
        [SerializeField] private bool monitorPerformance = true;
        [SerializeField] private float warningThreshold = 10;
        ...
        private void OnSpawnEvent(IEvent evt)
        {
            ...
            if (monitorPerformance)
            {
                ...
                {
                    UnityEngine.Debug.LogWarning($"[SpawnDebugger] High spawn count for {prefabName}: {_spawnCounts[prefabName]}");
                }
            }
