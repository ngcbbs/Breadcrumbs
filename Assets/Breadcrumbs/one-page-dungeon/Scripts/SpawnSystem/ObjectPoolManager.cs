...
namespace Breadcrumbs.SpawnSystem
{
    ...
    {
        [SerializeField] private List<ObjectPoolSettings> poolSettings = new List<ObjectPoolSettings>();
        ...
        /// </summary>
        public void ConfigurePool(GameObject prefab, int initialSize, int maxSize, bool expandWhenFull = true, float unusedDespawnTime = 60f)
        {
            int prefabId = prefab.GetInstanceID();
