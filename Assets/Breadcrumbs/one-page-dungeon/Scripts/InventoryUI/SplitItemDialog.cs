...
namespace Breadcrumbs.ItemSystem {
    public class SplitItemDialog : MonoBehaviour {
        [SerializeField]
        ...
        public void Show(InventorySlotUI slot) {
            ...
            quantitySlider.maxValue = quantity - 1; // 최소 1개는 남겨야 함
            quantitySlider.value = Mathf.FloorToInt(quantity / 2f); // 기본값은 절반
            OnSliderValueChanged(quantitySlider.value);
        ...
        private void OnSliderValueChanged(float value) {
            ...
            quantityText.text = $"{intValue} / {quantitySlider.maxValue + 1}";
        }
